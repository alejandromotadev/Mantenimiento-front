            ...
            <div>
                <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
                    ...
                    <div className={Style.createDiv}>
                        <button className={Style.createProjectButton}>Crear proyecto</button>
                    </div>
                </Modal>
